...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testcontext)
	{
		...
		extent.setSystemInfo("user", "Tasmiya");
		
		htmlReporter.config().setDocumentTitle("Urban Ladder Test Project");//Title of report
	...
	{
		logger=extent.createTest(tr.getName());//create new entry in the report
		logger.log(Status.FAIL, MarkupHelper.createLabel(tr.getName(), ExtentColor.RED));//send the passsed information
